...
def arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--body-object", required=True, help="Source body object")
    parser.add_argument("--head-object", required=True, help="Source head object")
    parser.add_argument("--output-object", required=True, help="Generated output object")
